...
const ValueAccumulator = struct {
    ...
    fn init(allocator: Allocator, physical_type: types.PhysicalType) ValueAccumulator {
        return .{
            .allocator = allocator,
    ...
    fn deinit(self: *ValueAccumulator) void {
    ...
    fn decodePlain(self: *ValueAccumulator, dec: *encoding.PlainDecoder, count: usize, allocator: Allocator) !void {
    ...
    fn decodeDictionary(self: *ValueAccumulator, rle_dec: *encoding.RleBitPackedDecoder, dict: *const DictionaryStore, count: usize, physical_type: types.PhysicalType, allocator: Allocator) !void {
        for (0..count) |_| {
    ...
    fn moveInto(self: *ValueAccumulator, col: *types.ParquetColumn) void {
        switch (self.physical_type) {
            .int32 => {
    ...
    fn expandWithNulls(self: *ValueAccumulator, allocator: Allocator, validity: []const bool, num_rows: usize, value_idx: *usize, col: *types.ParquetColumn) !void {
        _ = value_idx;
        switch (self.physical_type) {
            .int32 => {
...
const DictionaryStore = struct {
    ...
    fn init(allocator: Allocator, data: []const u8, physical_type: types.PhysicalType, num_values: usize) !DictionaryStore {
    ...
    fn deinit(self: *DictionaryStore) void {
        self.int32s.deinit(self.allocator);
        self.int64s.deinit(self.allocator);
        self.floats.deinit(self.allocator);
        self.doubles.deinit(self.allocator);
