...
const PhysicalType = types.PhysicalType;
const ConvertedType = types.ConvertedType;
const FieldRepetitionType = types.FieldRepetitionType;
const Encoding = types.Encoding;
const CompressionCodec = types.CompressionCodec;
const PageType = types.PageType;
const ParquetColumn = types.ParquetColumn;
const ParquetResult = types.ParquetResult;
